      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            ...
            onSelect={() =>
              dialog.confirm.open({
                title: `Reject invitation to ${invitation.workspace_name}`,
                description: 'Are you sure you want to reject joining this workspace?',
                variant: 'destructive',
                confirmLabel: 'Reject',
                method: 'delete',
                url: `/settings/workspaces/${invitation.workspace_id}/leave`,
              })
            }
          >
            Reject
